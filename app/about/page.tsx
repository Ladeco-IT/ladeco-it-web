    ...
    <main className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
      <div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-4 text-3xl font-semibold text-slate-950 sm:text-4xl">Professioneel, lokaal en direct inzetbaar.</h1>
        </div>
      ...
      <div className="mt-10 rounded-3xl border border-slate-200 bg-slate-50 p-6 text-slate-700">
        <div className="grid gap-6 sm:grid-cols-2">
          <div>
            <p className="text-sm font-semibold text-slate-950">Wat we doen</p>
            <p className="mt-3 text-sm leading-7">
              Computers samenstellen, software bouwen en netwerken beheren. Alles met een persoonlijke aanpak.
            </p>
          </div>
          <div>
            <p className="text-sm font-semibold text-slate-950">Hoe we werken</p>
            <p className="mt-3 text-sm leading-7">
